...
# Auto-detect folder name (user has 'food-101', code defaulted to 'food-101-subset')
POSSIBLE_DIRS = ["data/food-101", "food-101"]
INPUT_DIR = None
...
if INPUT_DIR is None:
    # Fallback to create defaults if missing
...
def main():
    ...
    for p in [1, 2, 4]:
        ...
        # FIXED: Using double braces {{ }} to escape parts for tqdm, and single { } for f-string values
    ...
    for w in [1, 2, 4]:
        ...
        # FIXED: Using double braces for f-strings
        pbar = tqdm(total=len(subset_images), 
